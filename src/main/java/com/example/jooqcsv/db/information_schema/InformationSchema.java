 ...
 */
package com.example.jooqcsv.db.information_schema;


import com.example.jooqcsv.db.DefaultCatalog;
import com.example.jooqcsv.db.information_schema.tables.Catalogs;
import com.example.jooqcsv.db.information_schema.tables.Collations;
import com.example.jooqcsv.db.information_schema.tables.ColumnPrivileges;
import com.example.jooqcsv.db.information_schema.tables.Columns;
import com.example.jooqcsv.db.information_schema.tables.Constants;
import com.example.jooqcsv.db.information_schema.tables.Constraints;
import com.example.jooqcsv.db.information_schema.tables.CrossReferences;
import com.example.jooqcsv.db.information_schema.tables.Domains;
import com.example.jooqcsv.db.information_schema.tables.FunctionAliases;
import com.example.jooqcsv.db.information_schema.tables.FunctionColumns;
import com.example.jooqcsv.db.information_schema.tables.Help;
import com.example.jooqcsv.db.information_schema.tables.InDoubt;
import com.example.jooqcsv.db.information_schema.tables.Indexes;
import com.example.jooqcsv.db.information_schema.tables.KeyColumnUsage;
import com.example.jooqcsv.db.information_schema.tables.Locks;
import com.example.jooqcsv.db.information_schema.tables.QueryStatistics;
import com.example.jooqcsv.db.information_schema.tables.ReferentialConstraints;
import com.example.jooqcsv.db.information_schema.tables.Rights;
import com.example.jooqcsv.db.information_schema.tables.Roles;
import com.example.jooqcsv.db.information_schema.tables.Schemata;
import com.example.jooqcsv.db.information_schema.tables.Sequences;
import com.example.jooqcsv.db.information_schema.tables.SessionState;
import com.example.jooqcsv.db.information_schema.tables.Sessions;
import com.example.jooqcsv.db.information_schema.tables.Settings;
import com.example.jooqcsv.db.information_schema.tables.Synonyms;
import com.example.jooqcsv.db.information_schema.tables.TableConstraints;
import com.example.jooqcsv.db.information_schema.tables.TablePrivileges;
import com.example.jooqcsv.db.information_schema.tables.TableTypes;
import com.example.jooqcsv.db.information_schema.tables.Tables;
import com.example.jooqcsv.db.information_schema.tables.Triggers;
import com.example.jooqcsv.db.information_schema.tables.TypeInfo;
import com.example.jooqcsv.db.information_schema.tables.Users;
import com.example.jooqcsv.db.information_schema.tables.Views;
...
public class InformationSchema extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1230124458;
